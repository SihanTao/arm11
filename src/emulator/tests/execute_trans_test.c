...
int main(void)
{
  ...
  add_test("Test for Trans execution");
  {
    ...
    /*
       ...
       #12, is_load = false is_up = false is_pre = " "false iFlag = true");
       ...
       #12, is_load = true is_up = true is_pre = false " "iFlag = false");
       ...
       #12, is_load = true is_up = false is_pre = " "false iFlag = true");
