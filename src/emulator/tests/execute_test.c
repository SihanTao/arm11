...
/*
  ...
  */
  ...
  add_test("Test for Trans execution");
  {
    ...
    execute_SDT(&trans_ins10, arm_state);
    ...
    execute_SDT(&trans_ins11, arm_state);
    ...
    execute_SDT(&trans_ins12, arm_state);
    ...
    execute_SDT(&trans_ins13, arm_state);
    ...
    execute_SDT(&trans_ins14, arm_state);
    ...
    execute_SDT(&trans_ins15, arm_state);
    ...
    execute_SDT(&trans_ins16, arm_state);
    ...
    execute_SDT(&trans_ins17, arm_state);
