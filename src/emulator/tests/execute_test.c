...
int main(void)
{
  ...
  //       to_int(arm_state->reg[2]),
  //       1,
  //       "STR Rd, [Rn], #12, 1011 becomes 1100..0010,  all false");
  ...
  //       to_int(arm_state->reg[1]),
  //       2,
  //       "LDR Rd, [Rn], #12, 11010 becomes 1010..0001, is_load = true is_up = false is_pre = false is_imm = false");
  ...
  //       to_int(arm_state->reg[2]),
  //       2,
  //       "STR Rd, [Rn], #12, 1011 becomes 1100..0010, is_load = false is_up = true is_pre = false is_imm = false");
  ...
  //   test_int_v(
  //       to_int(arm_state->reg[2]) - 0xC0000002,
  //       3,
  //       "STR Rd, [Rn, #12], 1011 becomes 1100..0010, is_load = false is_up = false is_pre = true is_imm = false");
  ...
  //   test_int_v(
  //       to_int(arm_state->reg[3]),
  //       1,
  //       "STR Rd, [Rn], #12, is_load = false is_up = false is_pre = false is_imm = true");
  ...
  //       to_int(arm_state->reg[1]),
  //       2,
  //       "LDR Rd, [Rn], #12, is_load = true is_up = true is_pre = false is_imm = false");
  ...
  //       to_int(arm_state->reg[1]),
  //       2,
  //       "LDR Rd, [Rn, #12], is_load = true is_up = false is_pre = true is_imm = false");
  ...
  //       to_int(arm_state->reg[2]),
  //       2,
  //       "LDR Rd, [Rn], #12, is_load = true is_up = false is_pre = false is_imm = true");
  ...
  //       to_int(arm_state->reg[2]) + 0xC0000002,
  //       3,
  //       "STR Rd, [Rn, #12], is_load = false is_up = true is_pre = true is_imm = false");
  ...
  //   test_true(&arm_state->reg[3] == &arm_state->reg[3] + 0xF4000001);
  //   test_int_v(
  //       to_int(arm_state->reg[3]),
  //       2,
  //       "STR Rd, [Rn], #12, is_load = false is_up = true is_pre = false is_imm = true");
  ...
  //   test_int_v(
  //       to_int(arm_state->reg[3]) - 0xA000000B,
  //       2,
  //       "STR Rd, [Rn, #12], is_load = false is_up = false is_pre = true is_imm = true");
  ...
  //       to_int(arm_state->reg[2]),
  //       2,
  //       "LDR Rd, [Rn, #12], is_load = true is_up = true is_pre = true is_imm = false");
  ...
  //       to_int(arm_state->reg[2]),
  //       2,
  //       "LDR Rd, [Rn], #12, is_load = true is_up = true is_pre = false is_imm = true");
  ...
  //       to_int(arm_state->reg[2]),
  //       2,
  //       "LDR Rd, [Rn, #12], is_load = true is_up = false is_pre = true is_imm = true");
  ...
  //   test_int_v(
  //       to_int(arm_state->reg[3]) + 0x00000016,
  //       1,
  //       "STR Rd, [Rn, #12], is_load = false is_up = true is_pre = true is_imm = true");
  ...
  //       to_int(arm_state->reg[2]),
  //       2,
  //       "LDR Rd, [Rn, #offset], is_load = true is_up = true is_pre = true is_imm = true");
